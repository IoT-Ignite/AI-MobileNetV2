...
def imgs_input_fn(filenames, perform_shuffle=False, repeat_count=1, batch_size=1):
    def read_decode(filename):
        ...
        features = tf.io.parse_single_example(filename,
...
def main():
    ...
    #    mobilenetModel.train( imgs_input_fn(args.train_file ,perform_shuffle=True,repeat_count=5,batch_size=20), steps =500)
